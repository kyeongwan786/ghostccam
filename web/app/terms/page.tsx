...
export const metadata: Metadata = { title: "이용약관 | Ghostcam", description: "Ghostcam 서비스 이용약관" };
...
export default function TermsPage() {
  return <main className="legal-page">
    ...
    <article className="legal-content">
      <p className="legal-kicker">GHOSTCAM / LEGAL</p><h1>이용약관</h1><p className="legal-lead">Ghostcam 서비스 이용과 관련한 기본 약속을 안내합니다.</p><p className="legal-date">시행일: 2026년 8월 3일</p>
      <section><h2>제1조 (목적)</h2><p>이 약관은 Ghostcam(이하 “서비스”)이 제공하는 사진 기반 심령 사진 합성 및 관련 기능의 이용 조건과 절차, 이용자와 서비스 운영자의 권리·의무를 정하는 것을 목적으로 합니다.</p></section>
